...
mongoose.connect(MONGO_URL)
    .then(() => console.log("MongoDB Connection Status:", mongoose.connection.readyState))
...
// app.set("view options", { async: true }); // Set async globally
...
//             return res.status(404).redirect("/listings"); // Redirect or render a 404 page
//         }

//         // Render the view without a callback
//         res.render("listings/show.ejs", { listing, curr:  req.user });
//     } catch (error) {
//         console.error(`Error fetching listing: ${error.message}`);
//         res.status(500).redirect("/listings"); // Redirect or render an error page
//     }
// });
